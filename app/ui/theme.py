...
_GLOBAL_CSS = f"""
<style id="sp-theme-{_CSS_VERSION}">
...
def inject_global_css() -> None:
    """
    Injeta o CSS global do tema.

    Em Streamlit, a página é rerenderizada com frequência. Por isso o CSS
    precisa ser reinjetado a cada execução, em vez de depender de session_state.
    """
