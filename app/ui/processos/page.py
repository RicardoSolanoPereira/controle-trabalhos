...
from ui.processos.sections import render_cadastro
...
def render(owner_user_id: int) -> None:
    ...
    if sec == SECTION_NOVO:
        render_cadastro(
            owner_user_id,
            button=_button,
            soft_note=_soft_note,
            pick_folder_dialog=_pick_folder_dialog,
            go_new=_go_new,
            open_edit=_open_edit,
            go_prazos=_go_prazos,
            duplicate_processo=_duplicate_processo,
            set_section=_set_section,
            toast=_toast,
            clear_data_cache=_clear_data_cache,
            guess_pasta_local=_guess_pasta_local,
            atuacao_db_from_label=_atuacao_db_from_label,
        )
